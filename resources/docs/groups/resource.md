...
curl -X POST \
    ...
    -F "file=@C:\Users\hkdse\AppData\Local\Temp\phpA294.tmp" 
```
...
```json
{
    "message": "could not find driver (SQL: select * from `resources`)",
    ...
    "trace": [
        ...
        {
            "file": "C:\\Users\\hkdse\\Documents\\GitHub\\Laravel-Web-App\\app\\Http\\Controllers\\API\\ResourceController.php",
            "line": 32,
            "function": "get",
            "class": "Illuminate\\Database\\Eloquent\\Builder",
            "type": "->"
        ...
        {
            "function": "index",
            "class": "App\\Http\\Controllers\\API\\ResourceController",
            "type": "->"
        },
        {
...
```json
{
    "message": "could not find driver (SQL: select * from `resources` where `id` = 1 limit 1)",
    "exception": "Illuminate\\Database\\QueryException",
    "file": "C:\\Users\\hkdse\\Documents\\GitHub\\Laravel-Web-App\\vendor\\laravel\\framework\\src\\Illuminate\\Database\\Connection.php",
    "line": 671,
    "trace": [
